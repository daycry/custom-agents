...
- **`/dev-cycle <objetivo>`** (`commands/dev-cycle.md`) — ciclo **completo** de desarrollo. Si arranca sobre una carpeta que ya trae spec+evaluación de `/pm-cycle`, sigue directo en la planificación.
