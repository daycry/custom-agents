...
---
<!-- Pie fijo -->
> Revisión adversarial de dos lentes (conformidad con spec/plan · calidad/robustez; lente C de seguridad si el diff lo amerita), contexto fresco. Solo se reportan gaps de corrección o de requisitos, no preferencias de estilo. Generado por la skill `adversarial-review` (desde `/dev-cycle` Fase 3 o a demanda).
