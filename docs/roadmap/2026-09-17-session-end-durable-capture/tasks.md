...
|---|---:|---:|---:|---:|---:|---:|---:|
| Fase 1 - Módulos compartidos | 2 | 2 | 100% | 0.55 / 2.5h | 0.42 / 0.8h | 0 / 0.2h | 0 / 45k |
| Fase 2 - Captura y materialización | 2 | 2 | 100% | 2.1 / 5.5h | 1.8 / 1.6h | 0 / 0.4h | 0 / 85k |
...
| **TOTAL** | **4** | **8** | **50%** | **2.65 / 14h** | **2.22 / 4.2h** | **0 / 1.1h** | **0 / 230k** |
