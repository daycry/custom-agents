...
**Trigger → artifact → does it publish? matrix** (the 10 known triggers that apply, or explicitly
...
disclosure: only the index + their area). Full detail: `CONVENTIONS.md` rule 10.
