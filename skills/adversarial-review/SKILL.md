...
frontmatter. Sin Jira activo (cuando hay ledger; a demanda sin ledger no aplica) → nada se publica. Nada de esto bloquea; lo obligatorio es el bucle acotado y la traza en el ledger.
