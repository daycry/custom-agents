...
de ficheros. Techo real medido con los títulos y rutas de este repo: **539
caracteres**.<!--m:bullet_max=539--> Y el camino que se promueve es, medido, el que produce los
bullets más LARGOS (`changelog` mediana 346 · `titulo` mediana 115)<!--m:changelog_mediana=346,titulo_mediana=115--> — es el precio de que el bullet diga algo. `RESUMEN_FRASES_MAX` es un tope
