...
bullets más LARGOS (`changelog` mediana 307 · `titulo` mediana 115)<!--m:changelog_mediana=307,titulo_mediana=115--> — es el precio de que el bullet diga algo. `RESUMEN_FRASES_MAX` es un tope
