...
- **La cola del ledger contaba como parte de la última tarea.** El split solo partía en `### T-XX`
  ...
  como su resumen. Medido: **24 de 33** ledgers del repo tienen cola tras su última `### T-XX` (de
  4 a 148 líneas) y **15 de los 17 cerrados** tenían la última tarea
  expuesta.<!--m:ledgers_con_cola=24,ledgers_totales=33,cerrados_con_cola=15,ledgers_cerrados=17-->
